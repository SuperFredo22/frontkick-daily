// Tabs of the Arsenal screen: the three content banques + projects + prospects.
// Shared so both the Banques page and BanqueList read the same labels/colors.
export const TABS = [
  ...
  { id: 'prospects',  label: 'Prospects',  color: 'var(--green)',  bg: 'var(--green-soft)' },
];

...
export const jalonsInitial = [
  { id: 1, titre: 'Publier 20 vidéos ce mois', categorie: 'Contenu', cible: 20, actuel: 0, unite: 'vidéos', echeance: '' },
  { id: 2, titre: 'Lancer 3 séries thématiques hebdo', categorie: 'Contenu', cible: 3, actuel: 0, unite: 'séries', echeance: '' },
  { id: 3, titre: '30 entraînements ce trimestre', categorie: 'Sport', cible: 30, actuel: 0, unite: 'séances', echeance: '' },
